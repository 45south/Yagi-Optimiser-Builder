...
- **(USER GUIDE.pdf)** — day-to-day usage, workflows, what
  the output means
...
every key is documented in `FIELD_REFERENCE.pdf`.
...
A quick map of what's available — see `FIELD_REFERENCE.pdf` for the full
